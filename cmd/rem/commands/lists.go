...
func init() {
	...
	listDeleteCmd.Flags().BoolVarP(&listDeleteForce, "force", "f", false, "Skip confirmation prompt")
	listDeleteCmd.Flags().BoolVarP(&listDeleteForce, "yes", "y", false, "Skip confirmation prompt (alias for --force)")
